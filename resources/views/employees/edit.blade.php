...
@section('content')
    <div class="page-header">
        ...
        <p class="page-subtitle">Actualizar información del empleado {{ $employee->full_name }}</p>
    </div>
            ...
            <div class="card-body">
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input class="form-control" type="text" name="dni" value="{{ old('dni', $employee->dni) }}"
                            maxlength="8" pattern="[0-9]{8}" placeholder="12345678" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control" type="email" name="email"
                            value="{{ old('email', $employee->email) }}" placeholder="ejemplo@trimax.com.pe" required>
                    </div>

                    <div class="col-md-6">
                        <label class="form-label">Teléfono</label>
                        <input class="form-control" type="text" name="phone"
                            value="{{ old('phone', $employee->phone) }}" placeholder="999 999 999">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select" name="active" required>
                            <option value="1" {{ old('active', $employee->active) == '1' ? 'selected' : '' }}>
                                Activo
                            </option>
                            <option value="0" {{ old('active', $employee->active) == '0' ? 'selected' : '' }}>
                                Inactivo
                            </option>
                        </select>
