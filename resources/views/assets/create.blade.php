            ...
            <div class="table-card animated-entry" style="animation-delay: 0.5s;">
                <form action="{{ route('asset.store') }}" method="POST" class="needs-validation form-control p-4"
                    ...
                    <div id="pc-laptop-fields" class="category-fields" style="display: none;">
                        ...
                        <input type="text" name="graphics_card" value="{{ old('graphics_card') }}"
                    ...
                    <div id="monitor-fields" class="category-fields" style="display: none;">
                        ...
                        <label>Tamaño de Pantalla: *</label>
                        <input type="text" name="screen_size_monitor" value="{{ old('screen_size_monitor') }}"
                        ...
                        <input type="text" name="refresh_rate" value="{{ old('refresh_rate') }}"
                            placeholder="Ej: 144Hz">
                    </div>
                    ...
                    <a href="{{ route('asset.index') }}">Cancelar</a>
                </form>
            </div>
        </div>
    </main>
